...
export const SIGN_UP_GENDER_OPTIONS: Array<{ value: SignUpGenderValue; label: string }> = [
  { value: 'MALE', label: '남성' },
  { value: 'FEMALE', label: '여성' },
  { value: 'OTHER', label: '기타' },
];

export const SIGN_UP_OCCUPATION_OPTIONS: Array<{ value: SignUpJobValue; label: string }> = [
...
export const SIGN_UP_TOPIC_OPTIONS: Array<{ value: SignupTopic; label: string; icon: string }> =
